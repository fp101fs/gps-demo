...
ALTER TABLE tracks ADD COLUMN IF NOT EXISTS battery_level INTEGER;
ALTER TABLE tracks ADD COLUMN IF NOT EXISTS battery_state TEXT;
...
ALTER TABLE tracks ADD COLUMN IF NOT EXISTS share_type TEXT DEFAULT 'live';
